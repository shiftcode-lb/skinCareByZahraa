  ...
  return (
      <div className="px-3 sm:px-4 md:px-11 lg:px-12 xl:px-12 2xl:px-16 my-10 max-w-screen-xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-10 w-full mt-10" >
            {/* Info Card */}
            <div className="h-full md:w-1/2 w-full" data-aos="fade-up" data-aos-delay="300">
            ...
            {/* Google Map */}
            <div className="rounded-lg overflow-hidden md:w-1/2 w-full" data-aos="fade-up" data-aos-delay="300">
              <iframe
                title="Google Maps"
