...
const ProcessCard = ({ icon, step, title, desc, shape }) => {
  return (
    <div className="flex flex-col items-center text-center relative sm:px-[25px] px-0" data-aos="fade-up" data-aos-delay="300">
      ...
      {/* Icon + Step number */}
      <div className="lg:w-[65px] lg:h-[65px] w-12.5 h-12.5 rounded-full flex items-center justify-center border border-borderColor relative">
        <i className={`${icon} text-[25px] text-primary`}></i>
